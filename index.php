    ...
    <div class="container body">
      <div class="main_container">
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            ...
            <center>
            &nbsp; <a href="index.php" class="fa fa-mortar-board fa-2x" style="color:#fff;"><span><font size="4.95" color="white" face="Helvetica Neue">  CRUD MAHASISWA</font></span></a>
            </center>
            </div>
              ...
              <ul class=" navbar-right">
                <li class="nav-item dropdown open" >
                  <a href="#" class="user-profile dropdown-toggle" aria-haspopup="true" id="navbarDropdown" data-toggle="dropdown" aria-expanded="false">
                    <img src="assets/images/user.png" alt="">Darell
                  </a>
      ...
      switch ($queries['page']) {
        ...
        <footer>
          ...
          Copyright @2020 Youtube-Fauzan Hilmi Edited By Darell Timotius *Thank you for sharing the source code, this is only use for academic purpose
          </div>
          <div class="clearfix"></div>
        </footer>
        <!-- /footer content -->
